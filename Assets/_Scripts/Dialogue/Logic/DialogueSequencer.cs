...
namespace Dialogues.Logic
{
    ...
    public class DialogueSequencer
    {
        ...
        public void EndDialogue(Dialogue dialogue)
        {
            ...
            {
                throw new DialogueException ("Trying to stop a dialogue that isnt running");
            }
        }
        ...
        public void StartDialogueNode(DialogueNode node)
        {
            ...
            {
                throw new DialogueException("Failed to start dialogue");
            }              
        }
        ...
        private void StopDialogueNode(DialogueNode node)
        {
            ...
            {
                throw new DialogueException("Trying to stop a dialogue node that isnt running.");
            }
        }
